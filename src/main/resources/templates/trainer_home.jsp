...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3"> <span> Category List</span></div>
    <div class="row">
     <!--  1 course -->
     <c:forEach items="${listTopic}" var="to" varStatus="status">
     <div class="col-md-4" style="margin-bottom: 25px">
        <div class="card">
            <a href="Category?id=${to.category_id}" style="text-decoration:none; outline: none">
            ...
            <div class="text-center">
                ...
                <h5>${to.category_name}</h5>

            </div>
            </a>
            <p style="border-top:1px solid #ccc; padding-left: 15px">Descripsion: ${to.category_des}</p>
        </div>
    </div>
     </c:forEach>
</div>
