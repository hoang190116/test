...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3"> <span> My Courses</span></div>
    <div class="row">
     <!--  1 course -->
     <c:forEach items="${listCourse}" var="c" varStatus="status">
     <div class="col-md-4" style="margin-bottom: 25px">
        <div class="card">
            <a href="Course?id=${c.c_id}" style="text-decoration:none; outline: none">
